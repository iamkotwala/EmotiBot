...
photo = PhotoImage(file='logom.png')
...
# button1
img = PhotoImage(file='play.png')  # make sure to add "/" not "\"
...
# button2
img2 = PhotoImage(file='stop.png')  # make sure to add "/" not "\"
